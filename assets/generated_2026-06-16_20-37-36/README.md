...
───────────────────────────────────────────────────────────────
  ...
  1. Copy app icon
     ...
     $ cp ./assets/generated_2026-06-16_20-37-36/ios/icon-1024.png ../expo/assets/images/icon.png

  2. Copy Android adaptive icon
     Copy the adaptive icon foreground for Android
     $ cp ./assets/generated_2026-06-16_20-37-36/android/mipmap-xxxhdpi/ic_launcher_foreground.png ../expo/assets/images/adaptive-icon.png

  3. Copy splash screen
     Copy a splash screen image (choose appropriate size for your needs)
     $ cp ./assets/generated_2026-06-16_20-37-36/ios/splash-1170x2532.png ../expo/assets/images/splash.png

  4. Copy web favicon
     Copy favicon.ico to public root and PNG favicons for web builds
     $ cp ./assets/generated_2026-06-16_20-37-36/web/favicon.ico ../public/ && cp ./assets/generated_2026-06-16_20-37-36/web/favicon-*.png ../public/
